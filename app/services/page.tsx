...
export default function Services() {
  const services = [
    ...
    {
      title: 'AI Solutions',
      description: 'Intelligent automation and AI-powered features to enhance your business processes and user experience.',
      features: ['Machine Learning', 'Natural Language Processing', 'Predictive Analytics', 'Chatbots & Virtual Assistants'],
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      features: ['Cloud Migration', 'Serverless Architecture', 'Auto-scaling', 'DevOps & CI/CD'],
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Digital transformation consulting to help you make informed technology decisions and optimize your processes.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">We understand your business goals and requirements</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We create a detailed roadmap and timeline</p>
            </div>
