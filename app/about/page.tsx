          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                At Orange County Web Development & AI Solutions, we believe technology should 
                empower businesses to reach their full potential. Our mission is to deliver 
                cutting-edge digital solutions that drive growth, efficiency, and innovation.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                We combine technical expertise with creative vision to create digital experiences 
                that not only meet your current needs but also scale with your future ambitions.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We never compromise on quality. Every project is delivered with attention to detail and excellence.
              </p>
            </div>
